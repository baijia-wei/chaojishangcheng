    ...
    <el-row>
      <el-col :span="7">
        <div class="post-aside">
          <pullDown @gainCityName="gainCityName" />
        </div>
      </el-col>
      ...
      <el-col :span="17" class="post-main">
        ...
        <wenzhang v-for="(item,index) in articleList" :key="item.id+index" :cardContent="item"></wenzhang>
        <el-pagination
...
<script>
import pullDown from "@/components/post/pullDown";
import wenzhang from "@/components/post/wenzhang";
export default {
  components: {
    pullDown,
    wenzhang
